...
A futuristic offline-first Android-oriented music player experience with local library, playlists, favorites, player UI, visual universe, Music Cinema, Audio Lab, Music DNA, Smart Queue, Replay, profiles, themes, bilingual UI, and persistent local state.
